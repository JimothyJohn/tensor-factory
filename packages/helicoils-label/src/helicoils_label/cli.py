"""`helicoils-label` CLI: push candidates into Label Studio, pull labels back to COCO.
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="helicoils-label")
    ...
    p.add_argument("--title", default="helicoils", help="project title")
