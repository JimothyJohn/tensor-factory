"""tensor-factory-label -- Label Studio integration for the helicoil annotation loop.
...
functions (:mod:`tensor_factory_label.convert`) are pure and testable; the REST client
(:mod:`tensor_factory_label.client`) talks to a running Label Studio over its HTTP API.
"""
