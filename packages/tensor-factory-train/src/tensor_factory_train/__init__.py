"""tensor-factory-train -- train the tiny detector and export an int8 ONNX model.

Only the torch-free data loader is exported eagerly; the model and training loop
import torch and are pulled in lazily by the CLI / :mod:`tensor_factory_train.train`, so
